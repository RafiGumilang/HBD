...
def tampilkan_halaman_1():
    putar_musik('assets/audio.mp3')  # Putar musik di halaman 1
...
def tampilkan_halaman_2():
    putar_musik('assets/audio.mp3')  # Putar musik di halaman 2
    st.markdown("""
        <style>
            @keyframes pulse {
                0% { opacity: 1; }
...
def tampilkan_halaman_3():
    putar_musik('assets/audio.mp3')  # Putar musik di halaman 3
    st.markdown("""
        <style>
            @keyframes pulse {
                0% { opacity: 1; }
...
def tampilkan_halaman_4():
    putar_musik('assets/audio.mp3')  # Putar musik di halaman 4
    st.markdown("""
        <style>
    ...
    gambar = muat_gambar('assets/foto.jpg')
    if gambar:
